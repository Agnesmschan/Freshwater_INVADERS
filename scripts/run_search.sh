...
SIG_DIR="../data/test_sra_signatures"
OUT_DIR="../data/outputs_test2"
TEMP_DIR="../data/temporary_files"
DB1="../data/gtdb-rs214-reps.k31.zip" #Microbiome control
DB2="../data/Invaders_k31_database.sbt.zip" #Custom database
...
sourmash gather -k 31 --threshold-bp 1000 "$FILE" "$DB1" "$DB2" -o "$OUTPUT_DATA"
